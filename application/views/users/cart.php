	...
	<div class="container-menu-header">
		...
		<div class="wrap_header">
			...
			<div class="header-icons">
				<a href="<?= base_url('') ?>" class="header-wrapicon1 dis-block">
...
<!-- Title Page -->
<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(<?= base_url('assets/') ?>images/heading-pages-01.jpg);">
					...
					<tr class="table-row">
						<td class="column-1">
							<div class="cart-img-product b-rad-4 o-f-hidden">
								<img src="<?= base_url('assets/') ?>images/item-10.jpg" alt="IMG-PRODUCT">
							</div>
						</td>
